...
NOTE: If infrastructure destruction fails and leaves behind unwanted GCP resources (e.g. due to partial Terraform destroys, state drift, or manual intervention), those resources may continue to incur cost.
