...
- [[#deploy-cloud-infrastructure-wip][Deploy Cloud Infrastructure (WIP)]]
  ...
  - [[#4-apply-manifest-files-into-the-cluster][4. Apply manifest files into the cluster]]
...
** 4. Apply manifest files into the cluster
*** Using kubectl
#+begin_src shell
...
** 5. Verify deployment
*** Using GCP Portal
- Go to [[https://console.cloud.google.com/][console.cloud.google.com]]:
  + Navigate to *Kubernetes Engine* → *Clusters*
  + Navigate to *Compute Engine* → *Overview*
  + Navigate to *Cloud Storage* → *Buckets*
  + Navigate to *VPC Netowkr* → *VPC Networks/IP Addresses/Firewall*
